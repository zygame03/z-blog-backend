...
// 	updateFunc               func(ctx context.Context, article *Article) error
// 	createFunc               func(ctx context.Context, article *Article) error
// 	incrementViewsFunc       func(ctx context.Context, id int, inc int64) error
// }

// func (f *fakeArticleRepo) listIDs(ctx context.Context) ([]int, error) {
...
// func (f *fakeArticleRepo) listByPage(ctx context.Context, page, pageSize int) ([]ArticleWithoutContent, int, error) {
...
// func (f *fakeArticleRepo) getByID(ctx context.Context, id int) (*Article, error) {
...
// func (f *fakeArticleRepo) listPopular(ctx context.Context, limit int) ([]ArticleWithoutContent, error) {
...
// func (f *fakeArticleRepo) update(ctx context.Context, article *Article) error {
// 	if f.updateFunc != nil {
// 		return f.createFunc(ctx, article)
// 	}
// 	return nil
// }

// func (f *fakeArticleRepo) create(ctx context.Context, article *Article) error {
// 	if f.createFunc != nil {
// 		return f.createFunc(ctx, article)
// 	}
// 	return nil
